$(function () {
    ...
    function join_inventory() {
        console.log("join inventory is working!"); // sanity check
        $.ajax({
            url: "/unirse-a-despensa/", // the endpoint
            type: "POST", // http method
            data: {inventory_code: $('#inventory-join-input').val()}, // data
    ...
    var dialogJoin = $("#join-inventory-form-wrapper").dialog({
        autoOpen: false,
        height: 200,
        width: 400,
        modal: true,
        buttons: {
            "Crear despensa": join_inventory,
            Cancel: function () {
        ...
        close: function () {
            joinForm[0].reset();
            dialogJoin.dialog('close');
            $('#inventory-join-input').removeClass("ui-state-error");
        }
    });
    ...
    $("#join-inventory-btn").button().on("click", function () {
    ...
    console.log($("#create-inventory-form-wrapper"));
    console.log($("#join-inventory-form-wrapper"));

    //    Muestra el formulario como una ventana de dialogo
    var dialogCreate = $("#create-inventory-form-wrapper").dialog({
        autoOpen: false,
        height: 200,
        width: 400,
        modal: true,
    ...
    $("#create-inventory-btn").button().on("click", function () {
